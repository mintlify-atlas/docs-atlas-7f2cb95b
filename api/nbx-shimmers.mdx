...
<ParamField path="heightFull" type="double" required>
  Total height of the widget
</ParamField>

<ParamField path="axis" type="Axis" required>
  Layout axis direction (horizontal or vertical)
</ParamField>

<ParamField path="skeletonListOneStyle" type="ShimmerSkeletonStyle" required>
  Style configuration for the first list of containers
</ParamField>

<ParamField path="itemCountListOne" type="int" required>
  Number of containers in the first list
</ParamField>

<ParamField path="isColumnListOne" type="bool" required>
  Whether the first list uses vertical layout
</ParamField>

<ParamField path="skeletonListTwoStyle" type="ShimmerSkeletonStyle" required>
  Style configuration for the second list of containers
</ParamField>

<ParamField path="itemCountListTwo" type="int" required>
  Number of containers in the second list
</ParamField>

<ParamField path="isColumnListTwo" type="bool" required>
